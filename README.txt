...
3. Copy the directory transfer bank into the following address wp-content/plugins/
4. Activate the plugin from the WordPress administration panel.
...
This acronym stands for Account Code

= what does CCI mean? =

This acronym stands for Interbank Account Code
